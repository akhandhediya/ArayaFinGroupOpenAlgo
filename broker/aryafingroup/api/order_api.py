...
from broker.aryafingroup.mapping.transform_data import transform_data , map_product_type, reverse_map_product_type, transform_modify_order_data
...
def modify_order(data,auth):
    ...
    # Make the request using the shared client
    response = client.put(f"{URLConfig.INTERACTIVE_URL}/orders",
        headers=headers,
        content=payload
    )
