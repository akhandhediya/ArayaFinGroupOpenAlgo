...
class AryafingroupWebSocketClient:
    """
    Aryafingroup XTS Socket.IO client for market data streaming
    ...
    API_BASE_URL = f"{URLConfig.MARKET_DATA_URL}/instruments/subscription"
    API_UNSUBSCRIBE_URL = f"{URLConfig.MARKET_DATA_URL}/instruments/subscription"  # Same endpoint, different method
    ...
    def __init__(self, api_key: str, api_secret: str, user_id: str, base_url: str = None):
        """
        Initialize the aryafingroup XTS Socket.IO client
    ...
    def connect(self):
        ...
        try:
            ...
            self.logger.info(f"Connecting to aryafingroup XTS Socket.IO: {connection_url}")
            ...
            self.logger.error(f"Failed to connect to aryafingroup XTS Socket.IO: {e}")
            if self.on_error:
    ...
    def disconnect(self):
        ...
        self.logger.info("Disconnected from Aryafingroup XTS Socket.IO")
    ...
    def _on_connect(self):
        ...
        self.connected = True
        self.logger.info("Connected to Aryafingroup XTS Socket.IO")
